...
export const sideBarWebMenu = [
  ...
  { title: 'Ticket Provider Api Token', icon: ApiIcon, path: '/validate-web-backend/ticket-provider-api-token' },
  { title: 'Ticket Provider Encryption Key', icon: VpnKeyIcon, path: '/validate-web-backend/ticket-provider-encryption-key' },
  { title: 'Ticket Transfer Log', icon: SendIcon, path: '/validate-web-backend/ticket-transfer' },
